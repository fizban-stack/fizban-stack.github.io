...
**[Basic Active Directory Network](https://docs.ludus.cloud/docs/environment-guides/basic-ad)** - A simpler AD setup for those just getting started with Active Directory penetration testing.
...
**[SANS Workshop: Active Directory](https://docs.ludus.cloud/docs/environment-guides/sans-workshop-active-directory)** - Lab environment based on SANS training materials.
...
**[Elastic Security](https://docs.ludus.cloud/docs/environment-guides/elastic-security)** - Lab environment with Elastic SIEM for practicing detection engineering and blue team operations.
