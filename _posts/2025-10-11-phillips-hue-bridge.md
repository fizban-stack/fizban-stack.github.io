...
category: Homelab
author: James Wells
excerpt: "Discovering hidden HTTP and API endpoints on a Philips Hue Bridge through Wireshark packet analysis."
tags: [IoT, Wireshark, API, Hue Bridge]
---
...
Then looking deeper into the pcap, I noticed the description.xml endpoint. When I went to this endpoint, I noticed it contained information about the device.
