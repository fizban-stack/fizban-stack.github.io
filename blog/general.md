...
layout: default
title: General - Blog
description: General blog posts and miscellaneous topics
...
<div class="blog-category">
  ...
  <nav class="category-nav">
    ...
    {% for category_group in posts_by_category %}
      {% if category_group.name != "General" %}
  ...
  {% assign category_posts = site.posts | where: "category", "General" %}
  ...
  {% else %}
    <p class="no-posts">No general posts yet. Check back soon!</p>
  {% endif %}
</div>
